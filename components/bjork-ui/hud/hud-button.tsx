...
export function HudButton({ 
  ...
  const glowVariants = {
    ...
    hover: {
      opacity: variant === "primary" ? (isDark ? 0.6 : 0.4) : 0.2,
      scale: 1.1,
      transition: {
        type: "spring",
        stiffness: 300,
    ...
    >
      <defs>
        <linearGradient id={gradientId1} x1="94.9995" y1="-62.017" x2="94.9995" y2="80.9853" gradientUnits="userSpaceOnUse">
          <stop stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.95" />
          <stop offset="0.005" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.92" />
          <stop offset="0.085" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.85" />
          <stop offset="0.17" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.75" />
          <stop offset="0.258" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.65" />
          <stop offset="0.351" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.55" />
          <stop offset="0.449" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.45" />
          <stop offset="0.554" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.35" />
          <stop offset="0.669" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.25" />
          <stop offset="0.804" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0.15" />
          <stop offset="1" stopColor={variant === "primary" ? colors.gradient : "#f8f9fa"} stopOpacity="0" />
        </linearGradient>
        <linearGradient id={gradientId2} x1="95.4995" y1="-65.5377" x2="95.4995" y2="83.1847" gradientUnits="userSpaceOnUse">
          <stop stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.8" />
          <stop offset="0.005" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.75" />
          <stop offset="0.085" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.65" />
          <stop offset="0.17" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.55" />
          <stop offset="0.258" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.45" />
          <stop offset="0.351" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.35" />
          <stop offset="0.449" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.25" />
          <stop offset="0.554" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.18" />
          <stop offset="0.669" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.12" />
          <stop offset="0.804" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0.06" />
          <stop offset="1" stopColor={variant === "primary" ? colors.gradient : "#e5e7eb"} stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      {[
        ...
        <motion.circle
          ...
          cy={dot.cy}
          r="1.161"
          fill={variant === "primary" ? colors.main : "#374151"}
          variants={dotVariants}
          initial="hidden"
          animate="show"
          whileHover="hover"
      ...
      <motion.path 
        ...
        stroke={variant === "primary" ? colors.border : "#374151"} 
        strokeWidth="0.5"
        initial={{ pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
        transition={{ 
