...
export function HoverDetailCard({
  ...
  const pillSurfaceClass =
    "inline-flex h-8 min-w-8 items-center justify-center rounded-[13px] border border-current/15 px-3 text-center text-sm font-semibold leading-[1] shadow-[inset_0_1px_0_rgba(255,255,255,0.48),0_8px_18px_-14px_currentColor] backdrop-blur-md dark:border-current/18 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_8px_18px_-16px_rgba(0,0,0,0.7)]";
  const iconPillSurfaceClass =
    "grid size-8 place-items-center rounded-[13px] border border-current/15 shadow-[inset_0_1px_0_rgba(255,255,255,0.48),0_8px_18px_-14px_currentColor] backdrop-blur-md dark:border-current/18 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_8px_18px_-16px_rgba(0,0,0,0.7)]";
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <motion.div 
                className={cn(pills.left.color, pills.left.textColor, pillSurfaceClass)}
              ...
              {pills.sparkle?.show && (
                <motion.div 
                  className={cn(pills.sparkle.color, iconPillSurfaceClass)}
                  variants={shouldAnimate ? pillVariants : {}}
            ...
            <motion.div 
              className={cn(pills.right.color, pills.right.textColor, pillSurfaceClass)}
              variants={shouldAnimate ? pillVariants : {}}
            >
              {pills.right.text}
            </motion.div>
