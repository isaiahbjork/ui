    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="top-[18vh] max-h-[min(650px,calc(100vh-4rem))] !max-w-3xl translate-y-0 overflow-hidden border-none bg-transparent p-2 shadow-none duration-150 data-[state=open]:slide-in-from-top-4 data-[state=closed]:slide-out-to-top-4 [&_[data-slot=dialog-close]]:hidden">
          ...
          >
            <Command
              className="rounded-[20px] border border-[color:var(--bjork-border-muted)] bg-[var(--bjork-field)] p-2.5 text-[color:var(--bjork-text)] shadow-[var(--bjork-shadow-surface)] backdrop-blur-xl [&_[cmdk-group-heading]]:px-4 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-[color:var(--bjork-text-soft)] [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-item]_svg]:size-4 [&_[data-slot=command-input-wrapper]]:h-[45px] [&_[data-slot=command-input-wrapper]]:rounded-[13px] [&_[data-slot=command-input-wrapper]]:border-transparent [&_[data-slot=command-input-wrapper]]:bg-[var(--bjork-field)] [&_[data-slot=command-input-wrapper]]:shadow-[var(--bjork-shadow-surface)] [&_[data-slot=command-input-wrapper]_svg]:size-4 [&_[data-slot=command-input-wrapper]_svg]:text-[color:var(--bjork-text-muted)] [&_[cmdk-input]]:h-10"
            >
              <CommandInput
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        <CommandItem
                          ...
                          className="group relative mx-1 cursor-default rounded-[13px] !px-4 py-2 text-sm text-[color:var(--bjork-text-medium)] transition-[background-color,color,transform] duration-150 ease-out data-[selected=true]:bg-[var(--bjork-field-muted)] data-[selected=true]:text-[color:var(--bjork-text)] data-[selected=true]:shadow-[var(--bjork-shadow-soft)]"
                        >
              ...
              <div className="absolute inset-x-2.5 bottom-2.5 flex h-11 items-center justify-between rounded-[15px] bg-[var(--bjork-field-muted)] px-4 text-xs text-[color:var(--bjork-text-soft)] shadow-[var(--bjork-shadow-soft)] backdrop-blur-xl">
