...
import { type BjorkTableThemeMode, useBjorkTableIsDark } from "./table-theme";
            ...
            >
              {indices.map((index, indexNum) => (
                ...
                <div className="flex items-center gap-4">
                  <div className={cn("flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border", isDark ? "border-[#2a2a2a]" : "border-[#eadfce]")}>
