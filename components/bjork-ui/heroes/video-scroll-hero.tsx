  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div
        ref={containerRef}
        className={cn(
          "relative bg-[var(--bjork-bg)]",
          previewMode ? "h-full min-h-[320px]" : "h-[200vh]",
        )}
      >
        ...
        <div
          className={cn(
            ...
            previewMode ? "relative h-full min-h-[320px]" : "sticky top-0 h-screen",
          )}
        >
          <div
          ...
          >
            <video
              ...
              playsInline
              className={cn(
                "rounded-2xl object-cover shadow-[var(--bjork-shadow-surface)]",
                previewMode
                  ? "h-[300px] w-[560px] max-w-[calc(100%-32px)]"
                  : "h-[60vh] w-[80vw] max-w-4xl",
              )}
            >
