...
type FuzzyCanvasElement = HTMLCanvasElement & { cleanupFuzzyText?: () => void }
...
>(({
  ...
  const innerRef = useRef<FuzzyCanvasElement>(null)
  const canvasRef = (ref as React.RefObject<FuzzyCanvasElement>) || innerRef
