          ...
          {newsCards.map((card) => {
             ...
             return (
               <motion.article
                 ...
                 className="group cursor-pointer overflow-hidden rounded-[20px] border border-[#d8d3c7] bg-[#f4f1e9] text-[#171717] shadow-[inset_0_7px_14px_rgba(255,255,255,0.62),inset_0_0.5px_0.5px_rgba(255,255,255,0.9),0_18px_34px_-16px_rgba(55,47,36,0.28)] transition-all duration-300 dark:border-[#161616] dark:bg-[#121212] dark:text-[#ededed] dark:shadow-[inset_0_7px_14px_rgba(255,255,255,0.03),inset_0_0.5px_0.5px_rgba(255,255,255,0.06),0_18px_34px_-16px_rgba(0,0,0,0.9)]"
               ...
               >
                 ...
                 <motion.div
                   ...
                   className="relative h-56 overflow-hidden bg-[#eee9df] dark:bg-[#090909]"
                 >
                   <img
                     src={card.image}
                     alt={card.title}
           ...
           {selectedCard && (
             <>
               ...
               <motion.div
                 ...
                 className="fixed inset-4 z-50 overflow-hidden rounded-[20px] border border-[#d8d3c7] bg-[#f4f1e9] text-[#171717] shadow-[inset_0_7px_14px_rgba(255,255,255,0.62),inset_0_0.5px_0.5px_rgba(255,255,255,0.9),0_24px_48px_-18px_rgba(55,47,36,0.4)] dark:border-[#161616] dark:bg-[#121212] dark:text-[#ededed] dark:shadow-[inset_0_7px_14px_rgba(255,255,255,0.03),inset_0_0.5px_0.5px_rgba(255,255,255,0.06),0_24px_48px_-18px_rgba(0,0,0,0.95)] md:inset-8 lg:inset-16"
               >
                 {/* Close Button */}
                 <motion.button
