...
export function TargetingUI({ className }: TargetingUIProps) {
  return (
    ...
    >
      ...
      >
        <motion.path d="M28 0.953125H27.75V2.82313H28V0.953125Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.8, duration: 0.1 }}
        />
        <motion.path d="M25.0776 1.03902L24.8281 1.05469L24.9453 2.92101L25.1948 2.90534L25.0776 1.03902Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.82, duration: 0.1 }}
        />
        <motion.path d="M22.1621 1.3046L21.9141 1.33594L22.1485 3.19119L22.3965 3.15985L22.1621 1.3046Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.84, duration: 0.1 }}
        />
        <motion.path d="M19.2778 1.75763L19.0312 1.80469L19.3818 3.64153L19.6284 3.59448L19.2778 1.75763Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.86, duration: 0.1 }}
        />
        <motion.path d="M16.4218 2.38304L16.1797 2.44531L16.6455 4.25637L16.8876 4.19409L16.4218 2.38304Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.88, duration: 0.1 }}
        />
        <motion.path d="M13.9452 5.05031L13.3672 3.27231L13.6052 3.19531L14.1832 4.97331L13.9452 5.05031Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.90, duration: 0.1 }}
        />
        <motion.path d="M10.8575 4.18149L10.625 4.27344L11.3124 6.01144L11.5449 5.9195L10.8575 4.18149Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.92, duration: 0.1 }}
        />
        <motion.path d="M8.16372 5.32327L7.9375 5.42969L8.7335 7.12181L8.95972 7.0154L8.16372 5.32327Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.94, duration: 0.1 }}
        />
        <motion.path d="M5.55504 6.66086L5.33594 6.78125L6.23644 8.42015L6.45555 8.29976L5.55504 6.66086Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.96, duration: 0.1 }}
        />
        <motion.path d="M3.0392 8.13947L2.82812 8.27344L3.8302 9.85228L4.04128 9.71831L3.0392 8.13947Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.98, duration: 0.1 }}
        />
        <motion.path d="M1.51206 11.4324L0.414062 9.91944L0.617058 9.77344L1.71506 11.2864L1.51206 11.4324Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 1.0, duration: 0.1 }}
        />
        <motion.path d="M30.6713 1.03208L30.5547 2.89844L30.8042 2.91403L30.9208 1.04767L30.6713 1.03208Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.82, duration: 0.1 }}
        />
        <motion.path d="M33.5853 1.30873L33.3516 3.16406L33.5996 3.19531L33.8334 1.33998L33.5853 1.30873Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.84, duration: 0.1 }}
        />
        <motion.path d="M36.4749 1.75677L36.125 3.59375L36.3716 3.64071L36.7215 1.80374L36.4749 1.75677Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.86, duration: 0.1 }}
        />
        <motion.path d="M39.1092 4.25681L38.8672 4.19381L39.3312 2.38281L39.5742 2.44581L39.1092 4.25681Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.88, duration: 0.1 }}
        />
        <motion.path d="M41.8005 5.05031L41.5625 4.97331L42.1405 3.19531L42.3785 3.27231L41.8005 5.05031Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.90, duration: 0.1 }}
        />
        <motion.path d="M44.8979 4.16698L44.2109 5.90625L44.4435 5.99809L45.1304 4.25882L44.8979 4.16698Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.92, duration: 0.1 }}
        />
        <motion.path d="M47.5842 5.32312L46.7891 7.01562L47.0153 7.12193L47.8105 5.42942L47.5842 5.32312Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.94, duration: 0.1 }}
        />
        <motion.path d="M50.197 6.65775L49.2969 8.29688L49.516 8.41721L50.4161 6.77808L50.197 6.65775Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.96, duration: 0.1 }}
        />
        <motion.path d="M52.7203 8.13959L51.7188 9.71875L51.9299 9.85265L52.9315 8.27349L52.7203 8.13959Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 0.98, duration: 0.1 }}
        />
        <motion.path d="M54.2421 11.4324L54.0391 11.2864L55.1371 9.77344L55.3401 9.91944L54.2421 11.4324Z" fill="white" opacity="0.3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.3 }}
          transition={{ delay: 1.0, duration: 0.1 }}
        />
      ...
      <g transform="translate(29, 22)">
        ...
        >
          <motion.path d="M1.25362 0.601562H0.640625V1.21456H1.25362V0.601562Z" fill="white"/>
          <motion.path d="M1.25362 2.82812H0.640625V2.97112H1.25362V2.82812Z" fill="white"/>
          <motion.path d="M1.25362 3.14844H0.640625V3.29144H1.25362V3.14844Z" fill="white"/>
          <motion.path d="M1.25362 6.67969H0.640625V9.15668H1.25362V6.67969Z" fill="white"/>
          <motion.path d="M1.25362 3.95312H0.640625V4.09612H1.25362V3.95312Z" fill="white"/>
          <motion.path d="M1.25362 4.8125H0.640625V4.9555H1.25362V4.8125Z" fill="white"/>
          <motion.path d="M1.25362 5.09375H0.640625V5.23675H1.25362V5.09375Z" fill="white"/>
          <motion.path d="M1.25362 5.375H0.640625V5.51801H1.25362V5.375Z" fill="white"/>
          <motion.path d="M1.25362 5.65625H0.640625V5.79925H1.25362V5.65625Z" fill="white"/>
          <motion.path d="M1.25362 10.0312H0.640625V10.1742H1.25362V10.0312Z" fill="white"/>
          <motion.path d="M1.25362 10.5312H0.640625V10.6742H1.25362V10.5312Z" fill="white"/>
        </motion.g>
