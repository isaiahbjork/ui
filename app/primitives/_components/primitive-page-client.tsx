...
const primitiveDemos: Record<string, PrimitiveDemo> = {
  accordion: {
    ...
    usageCode: `import { BjorkAccordion, BjorkAccordionItem, BjorkAccordionTrigger, BjorkAccordionContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
  ...
  alerts: {
    ...
    usageCode: `import { BjorkAlert, BjorkAlertTitle, BjorkAlertDescription } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "System alert",
  ...
  avatar: {
    ...
    usageCode: `import { BjorkShaderAvatar } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Shader avatar",
  ...
  breadcrumb: {
    ...
    usageCode: `import { BjorkBreadcrumb } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Page path",
  ...
  "button-group": {
    ...
    usageCode: `import { BjorkButtonGroup, BjorkButton } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
  ...
  calendar: {
    title: "Calendar",
    description: "A dark inset DayPicker skin for scheduling and date selection.",
    usageCode: `import { BjorkCalendar } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Single month",
        description: "Use in popovers, sheets, and scheduling surfaces.",
  ...
  checkbox: {
    ...
    usageCode: `import { BjorkCheckbox } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Checked row",
  ...
  collapsible: {
    ...
    usageCode: `import { BjorkCollapsible, BjorkCollapsibleTrigger, BjorkCollapsibleContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Inline reveal",
  ...
  combobox: {
    ...
    usageCode: `import { BjorkCombobox } from "@/components/isaiahbjork/primitives";`,
  ...
  "command-palette": {
    ...
    usageCode: `import { BjorkCommandPalette } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Global search",
  ...
  "data-table": {
    ...
    usageCode: `import { BjorkDataTable } from "@/components/isaiahbjork/primitives";`,
  ...
  "date-picker": {
    ...
    usageCode: `import { BjorkDatePicker } from "@/components/isaiahbjork/primitives";`,
  ...
  dialog: {
    ...
    usageCode: `import { BjorkDialog, BjorkDialogTrigger, BjorkDialogContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
  ...
  "dropdown-menu": {
    ...
    usageCode: `import { BjorkDropdownMenu } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Action menu",
  ...
  form: {
    ...
    usageCode: `import { BjorkFormPreview } from "@/components/isaiahbjork/primitives";`,
  ...
  "input-mask": {
    ...
    usageCode: `import { BjorkInputMask } from "@/components/isaiahbjork/primitives";`,
  ...
  "input-otp": {
    title: "Input OTP",
    description: "A six-slot verification code control.",
    usageCode: `import { BjorkInputOTP } from "@/components/isaiahbjork/primitives";`,
    examples: [{ label: "Verification code", description: "Use for one-time codes and short grouped entry.", preview: <BjorkInputOTP />, code: `<BjorkInputOTP />` }],
  },
  pagination: {
    title: "Pagination",
    description: "A grouped pagination control for tables and long result sets.",
    usageCode: `import { BjorkPagination } from "@/components/isaiahbjork/primitives";`,
  ...
  popover: {
    ...
    usageCode: `import { BjorkPopover, BjorkPopoverTrigger, BjorkPopoverContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Info popover",
  ...
  "radio-group": {
    ...
    usageCode: `import { BjorkRadioGroup } from "@/components/isaiahbjork/primitives";`,
  ...
  select: {
    title: "Select",
    description: "A compact option picker skinned for Bjork surfaces.",
    usageCode: `import { BjorkSelect } from "@/components/isaiahbjork/primitives";`,
    examples: [{ label: "Cadence select", description: "Use for compact option sets where search is unnecessary.", preview: <BjorkSelect />, code: `<BjorkSelect />` }],
  },
  sheet: {
    title: "Sheet",
    description: "A side panel for secondary workflows.",
    usageCode: `import { BjorkSheet, BjorkSheetTrigger, BjorkSheetContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Side sheet",
  ...
  sonner: {
    ...
    usageCode: `import { BjorkSonnerDemo } from "@/components/isaiahbjork/primitives";`,
  ...
  slider: {
    ...
    usageCode: `import { BjorkSlider } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
...
/>`,
  ...
  switch: {
    ...
    usageCode: `import { BjorkSwitch } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
...
/>`,
  ...
  table: {
    ...
    usageCode: `import { BjorkTable } from "@/components/isaiahbjork/primitives";`,
  ...
  tabs: {
    ...
    usageCode: `import { BjorkTabs } from "@/components/isaiahbjork/primitives";`,
  ...
  textarea: {
    ...
    usageCode: `import { BjorkTextarea } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Default textarea",
        description: "Use for longer text entry while keeping the same inset form style.",
        preview: <BjorkTextarea placeholder="Write a component note..." />,
        code: `<BjorkTextarea placeholder="Write a component note..." />`,
      },
      {
        label: "Filled textarea",
        description: "Use when the field sits inside a heavier settings block and needs a little more surface weight.",
        preview: (
          <BjorkTextarea
...
/>`,
      },
      {
        ...
        description: "Use disabled when the field is visible for context but cannot be edited yet.",
        preview: <BjorkTextarea disabled value="Locked until the draft is synced." readOnly />,
        code: `<BjorkTextarea
  disabled
  value="Locked until the draft is synced."
  readOnly
/>`,
      },
    ],
  ...
  tooltip: {
    ...
    usageCode: `import { BjorkTooltip, BjorkTooltipTrigger, BjorkTooltipContent } from "@/components/isaiahbjork/primitives";`,
    examples: [
      {
        label: "Icon hint",
...
function getPrimitiveBehaviorPropRow(slug: string) {
  const rows: Record<string, { name: string; value: string; description: string }> = {
    ...
    "input-otp": {
      name: "maxLength",
      value: "number",
      description: "Set the number of code slots and handle the completed one-time-code value.",
    },
    pagination: {
      name: "page",
      value: "number",
    ...
    select: {
      name: "value",
      value: "string",
      description: "Stores the selected menu item and updates through onValueChange.",
    },
    sheet: {
      name: "open",
      value: "boolean",
    ...
    textarea: {
      name: "value",
      value: "string",
      description: "Use normal textarea props for controlled text, placeholders, disabled state, and validation attributes.",
    },
    tooltip: {
      name: "content",
      value: "ReactNode",
